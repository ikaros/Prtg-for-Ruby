Gem::Specification.new do |s|
  ...
  s.description = 'This gem is a wrapper around the prtg http api.Prtg is an network monitoring solution which provides a api to retrieve several information about monitored devices.'
